...
@include('Layouts.sidebar')
  ...
  @yield('viewuser')
    ...
    <!-- apps -->
    <script src="../../dist2/js/app.min.js"></script>
    <script src="../../dist2/js/app.init.js"></script>
    <script src="../../dist2/js/app-style-switcher.js"></script>
    <!-- slimscrollbar scrollbar JavaScript -->
    <script src="../../dist2/libs/perfect-scrollbar/dist/js/perfect-scrollbar.jquery.js"></script>
    <script src="../../dist2/libs/jquery-sparkline/jquery.sparkline.min.js"></script>
    <!--Wave Effects -->
    <script src="../../dist2/js/waves.js"></script>
    <!--Menu sidebar -->
    <script src="../../dist2/js/sidebarmenu.js"></script>
    <!--Custom JavaScript -->
    <script src="../../dist2/js/feather.min.js"></script>
    <script src="../../dist2/js/custom.min.js"></script>
    <!--This page JavaScript -->
    <script src="../../dist2/libs/apexcharts/dist/apexcharts.min.js"></script>
    <!-- Chart JS -->
    <script src="../../dist2/js/pages/dashboards/dashboard1.js"></script>
  </body>
</html>